...
class AttributeController extends Controller
{
    ...
    public function store(AttributeRequest $request)
    {
        ...
        if (Attribute::create($params)) {
            Session::flash('swalsukses', 'Attribute has been saved');
        }
    ...
    public function destroy($id)
    {
        ...
        if ($attribute->delete()) {
            Session::flash('swalsukses', 'Attribute has been deleted');
        }
    ...
    public function store_option(AttributeOptionRequest $request, $attributeID)
    {
        ...
        if (AttributeOption::create($params)) {
            Session::flash('swalsukses', 'option has been saved');
        }
    ...
    public function update_option(AttributeOptionRequest $request, $optionID)
    {
        ...
        if ($option->update($params)) {
            Session::flash('swalsukses', 'Option has been updated');
        }
    ...
    public function remove_option($optionID)
    {
        ...
        if ($option->delete()) {
            Session::flash('swalsukses', 'option has been deleted');
        }
