...
class ProductController extends Controller
{
    ...
    public function store(ProductRequest $request)
    {
        ...
        if ($product) {
            Session::flash('swalsukses', 'Product has been saved');
        } else {
            Session::flash('swalerror', 'Product could not be saved');
        }
    ...
    public function update(ProductRequest $request, $id)
    {
        ...
        if ($saved) {
            Session::flash('swalsukses', 'Product has been Updated');
        } else {
            Session::flash('swalerror', 'Product could not be Updated');
        }
    ...
    public function destroy($id)
    {
        ...
        if ($product->delete()) {
            Session::flash('swalsukses', 'Product has been deleted');
        }
        return redirect('admin/products');
    }
    ...
    public function upload_image(ProductImageRequest $request, $id)
    {
        ...
        if ($request->has('image')) {
            ...
            if (ProductImage::create($params)) {
                Session::flash('swalsukses', 'Image has been Updated');
            } else {
                Session::flash('swalerror', 'Image could not be Updated');
            }
    ...
    public function remove_image($id)
    {
        ...
        if ($image->delete()) {
            ...
            Session::flash('swalsukses', 'Image has been Deleted');
        }
