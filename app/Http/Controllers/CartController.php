...
class CartController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Session::flash('swalsukses', 'Product ' . $item['name'] . ' has been added to cart');
    ...
    public function update(Request $request)
    {
        ...
        if ($items = $params['items']) {
            ...
            Session::flash('swalsukses', 'The cart has been updated');
    ...
    {
        Cart::remove($id);
        Session::flash('swalsukses', 'Product has been removed');
        return redirect('carts');
    }
}
